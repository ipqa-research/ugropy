...
trials_unifac = [
    ...
    ("[SiH3][Si]([SiH3])([SiH3])OC=O", {"HCOO": 1, "SIH3": 3, "SI": 1}, "smiles"),
    ...
    ("COC(=O)O[Si](C)(C)C", {"CH3O": 1, "COO": 1, "SI": 1, "CH3": 3}, "smiles"),
    ("CCOC(=O)O[SiH3]", {"CH2O": 1, "COO": 1, "SIH3": 1, "CH3": 1}, "smiles"),
    ("CCOC(=O)O[SiH2]C", {"CH2O": 1, "COO": 1, "SIH2": 1, "CH3": 2}, "smiles"),
    ("CCOC(=O)O[SiH](C)C", {"CH2O": 1, "COO": 1, "SIH": 1, "CH3": 3}, "smiles"),
    ("CCOC(=O)O[Si](C)(C)C", {"CH2O": 1, "COO": 1, "SI": 1, "CH3": 4}, "smiles"),
    ("CC(C)OC(=O)O[SiH3]", {"CH-O": 1, "COO": 1, "SIH3": 1, "CH3": 2}, "smiles"),
    ("C[SiH2]OC(=O)OC(C)C", {"CH-O": 1, "COO": 1, "SIH2": 1, "CH3": 3}, "smiles"),
    ("CC(C)OC(=O)O[SiH](C)C", {"CH-O": 1, "COO": 1, "SIH": 1, "CH3": 4}, "smiles"),
    ("CC(C)OC(=O)O[Si](C)(C)C", {"CH-O": 1, "COO": 1, "SI": 1, "CH3": 5}, "smiles"),
    ("C[SiH2]OC(=O)OC(C)(C)C", {"SIH2O": 1, "COO": 1, "C": 1, "CH3": 4}, "smiles"),
    ("C[SiH](C)OC(=O)OC(C)(C)C", {"SIHO": 1, "COO": 1, "C": 1, "CH3": 5}, "smiles"),
    ("CC(C)(C)OC(=O)O[Si](C)(C)C", {"SIO": 1, "COO": 1, "C": 1, "CH3": 6}, "smiles"),
    ...
    ("COCO[SiH2][SiH3]", {"CH3O": 1, "CH2O": 1, "SIH2": 1, "SIH3": 1}, "smiles"),
    ("[SiH3]OCO[SiH2][SiH3]", {"SIH3": 2, "SIH2O": 1, "CH2O": 1}, "smiles"),
    ("C[SiH2]OCO[SiH2][SiH3]", {"SIH3": 1, "SIH2O": 1, "CH2O": 1, "SIH2": 1, "CH3": 1}, "smiles"),
    ("C[SiH](C)OCO[SiH2][SiH3]", {"SIH3": 1, "SIH2O": 1, "CH2O": 1, "SIH": 1, "CH3": 2}, "smiles"),
    ("C[Si](C)(C)OCO[SiH2][SiH3]", {"SIH3": 1, "SIH2O": 1, "CH2O": 1, "SI": 1, "CH3": 3}, "smiles"),
    ("CC(C)(C)OCO[SiH2][SiH3]", {"SIH3": 1, "SIH2O": 1, "CH2O": 1, "C": 1, "CH3": 3}, "smiles"),
    ("CC(C)OCO[SiH2][SiH3]", {"SIH3": 1, "SIH2": 1, "CH2O": 1, "CH-O": 1, "CH3": 2}, "smiles"),
    ("[SiH3]OCO[SiH]([SiH3])[SiH3]", {"SIH3": 3, "SIHO": 1, "CH2O": 1}, "smiles"),
    ("C[SiH](C)OCO[SiH]([SiH3])[SiH3]", {"SIH3": 2, "CH3": 2, "SIHO": 1, "SIH": 1, "CH2O": 1}, "smiles"),
    ("C[Si](C)(C)OCO[SiH]([SiH3])[SiH3]", {"SIH3": 2, "CH3": 3, "SIHO": 1, "SI": 1, "CH2O": 1}, "smiles"),
    ("CC(C)(C)OCO[SiH]([SiH3])[SiH3]", {"SIH3": 2, "CH3": 3, "SIHO": 1, "C": 1, "CH2O": 1}, "smiles"),
    ("COCO[SiH]([SiH3])[SiH3]", {"SIH3": 2, "CH3O": 1, "SIH": 1, "CH2O": 1}, "smiles"),
    ("CC(C)OCO[SiH]([SiH3])[SiH3]", {"SIH3": 2, "CH3": 2, "CH-O": 1, "SIH": 1, "CH2O": 1}, "smiles"),
    ("CCOCO[SiH]([SiH3])[SiH3]", {"SIH3": 2, "CH3": 1, "SIH": 1, "CH2O": 2}, "smiles"),
    ("[SiH3]OCO[Si]([SiH3])([SiH3])[SiH3]", {"SIH3": 4, "SIO": 1, "CH2O": 1}, "smiles"),
    ("C[Si](C)(C)OCO[Si]([SiH3])([SiH3])[SiH3]", {"SIH3": 3, "SIO": 1, "CH2O": 1, "SI": 1, "CH3": 3}, "smiles"),
    ("CC(C)(C)OCO[Si]([SiH3])([SiH3])[SiH3]", {"SIH3": 3, "SIO": 1, "CH2O": 1, "C": 1, "CH3": 3}, "smiles"),
    ("COCO[Si]([SiH3])([SiH3])[SiH3]", {"SIH3": 3, "SI": 1, "CH2O": 1, "CH3O": 1}, "smiles"),
    ("CC(C)OCO[Si]([SiH3])([SiH3])[SiH3]", {"SIH3": 3, "SI": 1, "CH2O": 1, "CH-O": 1, "CH3": 2}, "smiles"),
    ("CC(O[SiH3])O[SiH2][SiH3]", {"SIH3": 2, "CH3": 1, "CH-O": 1, "SIH2O": 1}, "smiles"),
    ("CC(O[SiH2][SiH3])O[SiH](C)C", {"SIH3": 1, "SIH": 1, "CH3": 3, "CH-O": 1, "SIH2O": 1}, "smiles"),
    ("CC(O[SiH2][SiH3])OC(C)(C)C", {"SIH3": 1, "C": 1, "CH3": 4, "CH-O": 1, "SIH2O": 1}, "smiles"),
    ("COC(C)O[SiH2][SiH3]", {"SIH3": 1, "CH3": 1, "CH3O": 1, "CH-O": 1, "SIH2": 1}, "smiles"),
    ("CC(C)OC(C)O[SiH2][SiH3]", {"SIH3": 1, "CH3": 3, "CH-O": 2, "SIH2": 1}, "smiles"),
    ("CCOC(C)O[SiH2][SiH3]", {"SIH3": 1, "CH3": 2, "CH-O": 1, "CH2O": 1, "SIH2": 1}, "smiles"),
    ("CC(O[SiH](C)C)O[SiH]([SiH3])[SiH3]", {"SIH3": 2, "CH3": 3, "CH-O": 1, "SIHO": 1, "SIH": 1}, "smiles"),
    ("CC(O[SiH3])O[SiH]([SiH3])[SiH3]", {"SIH3": 3, "CH3": 1, "CH-O": 1, "SIHO": 1}, "smiles"),
    ("CC(O[SiH]([SiH3])[SiH3])OC(C)(C)C", {"SIH3": 2, "CH3": 4, "CH-O": 1, "SIHO": 1, "C": 1}, "smiles"),
    ("CC(C)OC(C)O[SiH]([SiH3])[SiH3]", {"SIH3": 2, "CH3": 3, "CH-O": 2, "SIH": 1}, "smiles"),
    ("COC(C)O[SiH]([SiH3])[SiH3]", {"SIH3": 2, "CH3": 1, "CH3O": 1, "CH-O": 1, "SIH": 1}, "smiles"),
    ("CC(O[SiH3])O[Si]([SiH3])([SiH3])[SiH3]", {"SIH3": 4, "CH3": 1, "CH-O": 1, "SIO": 1}, "smiles"),
    ("CC(OC(C)(C)C)O[Si]([SiH3])([SiH3])[SiH3]", {"SIH3": 3, "CH3": 4, "CH-O": 1, "SIO": 1, "C": 1}, "smiles"),
    ("CC(C)OC(C)O[Si]([SiH3])([SiH3])[SiH3]", {"SIH3": 3, "CH3": 3, "CH-O": 2, "SI": 1}, "smiles"),
    ("COC(C)O[Si]([SiH3])([SiH3])[SiH3]", {"SIH3": 3, "CH3": 1, "CH3O": 1, "CH-O": 1, "SI": 1}, "smiles"),
    # quadtruplets
