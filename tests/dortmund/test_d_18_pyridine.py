...
trials = [
    ...
    (
        "CC(C)(C)C1=NC(O)=CC=C1",
        {"AC2N": 1, "ACH": 3, "OH (P)": 1, "C": 1, "CH3": 3},
        "smiles",
    ),
    ("OC1=CC=CC(O)=N1", {"AC2N": 1, "ACH": 3, "OH (P)": 2}, "smiles"),
    (
        "CC1=CC=CC(O)=N1",
        {"AC2N": 1, "ACH": 3, "CH3": 1, "OH (P)": 1},
        "smiles",
    ),
    ...
    (
        "CC1=CC(C)=C(C)C=N1",
        {"ACH": 1, "AC2HN": 1, "ACCH3": 2, "CH3": 1},
        "smiles",
    ),
    ("C1=CC=C(C=C1)C1=CC=NC=C1", {"AC2H2N": 1, "AC": 2, "ACH": 7}, "smiles"),
    (
        "CC(=C)C1=CC=NC=C1",
        {"ACH": 2, "AC2H2N": 1, "AC": 1, "CH2=C": 1, "CH3": 1},
        "smiles",
    ),
