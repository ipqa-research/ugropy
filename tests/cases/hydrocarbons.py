...
hydrocarbons_cases = [
    ...
    Case(
        ...
        joback_result={"-CH3": 1, "-CH2-": 4, ">CH-": 3, ">C<": 2},
    ),
    Case(
        "CCC(CC)C(C)(C)C",
        "smiles",
