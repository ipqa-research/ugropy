...
# Different arguments to pass to each solver.
arguments = [{}, {"solver": "XPRESS_PY"}]
...
class TCase(ABC):
    ...
    @abstractmethod
    def asserts(
        self, case: Case, solver: ILPSolver, arguments: list
    ) -> None: ...
    ...
    def test_acids(
        ...
        self.asserts(case, solver, arguments)
